<?php if(!isset($_GET['edit_id'])  ):  ?> 
                                ...
                                <div class="col-12 no-padding">
                                    ...
                                    <p class="small-text dashboard-title3-bold primary-color1" style="margin-bottom:0px;">Plan type</p>
                                     <h6 class="dashboard-title3-bold module-name secondary-color1" style="margin-bottom:100px;">INSTALMENT</h6> 
                                      -->
                                        <input type="hidden" value="ONE_TIME_PAYMENT" name="plan_type">
                                </div>
                            </div>  
                            ...
                            <div class="row vertical-middle" style="margin:0 auto 20px;max-width:500px;">
                                <div class="col-12 no-padding">
                                    <p class="small-text dashboard-title3-bold primary-color1" > Total payment amount  </p>
                            ...
                            <div class="row vertical-middle" style="margin:0 auto 20px;max-width:500px;">
                                <div class="col-12 no-padding">
                                    ...
                                    <input type="text" name="plan_title" class=" form-control" name="plan_title" required style="margin-bottom:0px;">
                                </div>
                            </div>
                            <div class="row vertical-middle" style="margin:0 auto 20px;max-width:500px;">
                                <div class="col-12 no-padding">
                                    <p class="small-text dashboard-title3-bold primary-color1" >custom phrase to describe the plan</p>
                                    <textarea class="form-control" name="plan_description" cols="5" style="margin-bottom:0px;height:100px;" required></textarea>
                                </div>
                            </div>  
...
?>                             
                            ...
                            <div class="row vertical-middle" style="margin:0 auto 20px;max-width:500px;">
                                <div class="col-12 no-padding">
                                    <p class="small-text dashboard-title3-bold primary-color1" > Plan Title </p>
                                    <input type="text" name="plan_title" class=" form-control" value="<?php echo $val->plan_title ?>" name="plan_title" required style="margin-bottom:0px;">
                                </div>
                            </div>
                            <div class="row vertical-middle" style="margin:0 auto 20px;max-width:500px;">
                                <div class="col-12 no-padding">
                                    <p class="small-text dashboard-title3-bold primary-color1" >custom phrase to describe the plan</p>
                                    <textarea class="form-control" name="plan_description" cols="5" style="margin-bottom:0px;height:100px;" value="EDIT" required><?php echo $val->plan_description ?></textarea>
                                </div>
                            </div>   

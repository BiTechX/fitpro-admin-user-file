...
$query = "";
 ...
 ?>
    <script> var all_cat = "";  var all_type = ''; </script>
    ...
    secondary-color1-border secondary-color1-border-hover secondary-color1-hover white-background-hover no-padding-mobile" style="margin-bottom:20px;width:100%;" type="submit">SEARCH</button>
                    ...
                    <div class="col-xl-8 order-0 order-xl-1" >
                       ...
                       <div style="max-width:720px;margin:0px auto 20px;">
                           <h1 class="dashboard-title primary-color1 text-left" style="margin-bottom:5px;"><a href="homepage.php"><i class="flt flaticon-back primary-color1" style="margin-right:20px;vertical-align:top;"></i></a>YOUR PRODUCTS</h1>
                            ...
                            <div class="col-xl-4 col-md-6 col-12 course-card" >
                                <div class="course-card-inner">
                                    <div class="normal-state">
                                        <img src="<?php echo the_post_thumbnail_url();?>" style="height:150px;width:100%;object-fit:cover;">
                                        <div class="grey-border" style="border-top:0px;height:90px;padding-top:13px;">
                                            ...
                                            <p class="small-text secondary-color1 dashboard-title3-bold text-center"><?php echo $product->get_price_html(); ?></p>                                            
                                        </div>
                                    </div>
                                    <div class="hover-state" style="background-image: linear-gradient(<?php echo hex2rgb($primary_color_1_HEX , '0.9'); ?>, <?php echo hex2rgb($primary_color_1_HEX , '0.9'); ?> ),url(<?php echo the_post_thumbnail_url(); ?>);" >
                                        <p class="primary-color2 text-left" style="font-size:10px;"><i><?php echo $product_cat[0]->name ;?></i></p>
                                        ...
                                        <p class="small-text primary-color2 dashboard-title3 text-center" style="font-size:10px;"></p>
                                        <p class="small-text primary-color2 dashboard-title3-bold text-center" style="font-size:20px;margin-bottom:24px;"><?php echo $product->get_price_html(); ?></p>
                                        
                                        
                                        <div class="row no-margin">
                                            <div class="col-6 " style="padding:0px 5px 0px 0px;">
                                                <a href = "<?php echo get_site_url()."/admin/edit_product.php?id=".get_the_ID();?>" ><button class="btn theme-rounded-button primary-color1 primary-color2-background primary-color2-border primary-color2-border-hover transparent-background-hover primary-color2-hover" style="width:100%;padding: 1em 1.5em!important;box-shadow:none!important;" >EDIT</button></a>
                                            </div>
                                            <div class="col-6 " style="padding:0px 0px 0px 5px;">
                                                    <button class="btn theme-rounded-button primary-color1-hover primary-color2-background-hover primary-color2-border primary-color2-border-hover  transparent-background primary-color2" style="width:100%;padding: 1em 1.5em!important;box-shadow:none!important;" value = "<?php echo get_the_ID(); ?>" id = "deleteButton">DELETE</button>
                                                </div>
                                        </div>
...
/*
    ...
    $(document).on('click', "#deleteButton", function(e) {
        var value = $(this).val();
        var sendData = new FormData();
        sendData.append('id' , value);
        $.ajax({
    		url : "woocommerce_api/delete_product.php",
    		data : sendData,
    		async: false,
            contentType: false,
            processData: false,

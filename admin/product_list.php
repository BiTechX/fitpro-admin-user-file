                                ...
                                <div class="course-card-inner">
                                    <div class="normal-state">
                                        ...
                                        <div class="grey-border" style="border-top:0px;height:90px;padding-top:13px;">
                                            <p class="small-text primary-color1 dashboard-title3-bold text-center" style="text-transform:none;height:44px;">NAME OF THE PRODUCT</p>
                                            <p class="small-text secondary-color1 dashboard-title3-bold text-center">$99.99</p>                                            
                                        </div>
                                    </div>
                                    <div class="hover-state" style="background-image: linear-gradient(<?php echo hex2rgb($primary_color_1_HEX , '0.9'); ?>, <?php echo hex2rgb($primary_color_1_HEX , '0.9'); ?> ),url(<?php echo get_post_meta($post->ID, 'fitpro_th_course_image', true);?>);" >
                                        ...
                                        <p class="small-text primary-color2 dashboard-title3-bold text-center" style="text-transform:none;height:44px;">NAME OF THE PRODUCT</p>
                                        <p class="small-text primary-color2 dashboard-title3 text-center" style="font-size:10px;">⠀</p>
                                        <p class="small-text primary-color2 dashboard-title3-bold text-center" style="font-size:20px;margin-bottom:24px;">$99.99</p>
                                        ...
                                        <div class="row no-margin">
                                            ...
                                            <div class="col-6 " style="padding:0px 0px 0px 5px;">
                                                    <a href = <?php echo get_site_url()."/user/modules_page.php?id=".get_the_ID(); ?>><button class="btn theme-rounded-button primary-color1-hover primary-color2-background-hover primary-color2-border primary-color2-border-hover  transparent-background primary-color2" style="width:100%;padding: 1em 1.5em!important;box-shadow:none!important;" >DELETE</button></a>
                                                </div>
                                        </div>
                                        <?php else:?>

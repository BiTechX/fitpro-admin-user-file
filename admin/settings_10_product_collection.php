    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="padding-15px" style="margin-bottom:20px;">
                ...
                <a href="settings_10_product_collection.php"><button class="btn theme-rounded-button secondary-color1-border secondary-color1-border-hover secondary-color1 transparent-background top-bar-button current-page-button" >Product Collection</button></a>           
                ...
                <div class="row no-margin">
                    <div class="col-xl-6 col-lg-6">
                        ...
                        <form action="javascript:void(0)" id="AddNewCollection" >
                            <div class ="row no-margin"  style="align-items:center;margin-bottom:20px;">
                                <div class="col-xl-8 col-lg-8">
                                     <div class="form-group">
                                        <h6 class="dashboard-title3 small-text secondary-color1" style="text-transform:none;">Add Collection</h6>
                                        <input type="text" class="form-control" name ="collection_name" required placeholder="">
                                    </div>  
                                </div>
                                <div class="col-xl-8 col-lg-8">
                                     <div class="form-group">
                                        <h6 class="dashboard-title3 small-text secondary-color1" style="text-transform:none;"> Collection Description</h6>
                                         <textarea class="form-control"cols="5" name="collection_description" ></textarea>
                                    </div>  
                                </div>
                                ...
                                <div class="drop-shadow card-holder">
                                    <div class="row">
                                       <!-- <div class="col-1 backend-module-edit-iconsholder backend-module-edit-iconsholder-left">
                                        ...
                                        <div class="col-7">
                                            <h6 class="primary-color1 module-name dashboard-title3"><?php echo $collection['collection_name'] ;?></h6>
                                        </div>
                                        <div class="col-4 backend-module-edit-iconsholder "  >
                                            <!--<i class="flt flaticon-writing  primary-color1"></i>-->
                                            <i class="flt flaticon-rubbish-bin secondary-color1" style="padding-left:10px;" id="delete_collection" data-id="<?php echo $collection['id']; ?>"></i>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).on('submit', "#AddNewCollection", function(e) {
    
    
            var postvalue =  jQuery(this).serialize();
            var url = "woocommerce_api/add_collection.php";
      ...
      $(document).on('click', "#delete_collection", function(e) {
            ...
            var isconf = confirm("Are You Sure to Delete This Collection ? ");
            if(isconf){
                
                var value =  jQuery(this).data("id");
                var url = "woocommerce_api/delete_collection.php";
                    ...
                    $.ajax({
                        ...
                        success: function(result){
                            if(result == 1){
                                ...
                                alert('Collection was not deleted');
                            }
                            console.log(result);
                           jQuery("#ActionButton").prop("disabled",false);

...
<script>
    ...
    {
        if(!(/^(https?:\/\/)?((w{3}\.)?)facebook\.com\/(#!\/)?[A-Za-z0-9_.]+$/i.test(Fburl))   && !(/^ *$/.test(Fburl))   ){
             alert("Please use the format: https://www.facebook.com/XXXXXXXX") ;
             return false;
        }
        else if (!(/^(https?:\/\/)?((w{3}\.)?)twitter\.com\/(#!\/)?[a-z0-9_]+$/i.test(twurl))   && !(/^ *$/.test(twurl)) ){
             alert("Please use the format: https://twitter.com/XXXXXXXXX") ;
             return false; 
        }
        
        else if(!(/^(https?:\/\/)?((w{3}\.)?)linkedin\.com\/.*/i.test(linurl))  && !(/^ *$/.test(linurl))  ){
             alert("Please use the format: https://www.linkedin.com/in/XXXXXXXX") ;
             return false;
        }
        else if(!(/^(https?:\/\/)?((w{3}\.)?)instagram\.com\/.*/i.test(insturl)) && !(/^ *$/.test(insturl))   ){
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="padding-15px" style="margin-bottom:20px;">
             ...
             <form action="javascript:void(0)" id="UserInfoUpdate" >
                ...
                <div class="row no-margin d-flex flex-wrap">
                    <div class="col-xl-3 col-lg-4 order-1 order-lg-0">
                            ...
                            <div class="form-group">
                                <h6 class="dashboard-title3 small-text secondary-color1" style="text-transform:none;"> Job Title </h6>
                                <input type="text" required class="form-control" name = "title" value="<?php echo $user_Info->user_short_title ;?>" placeholder="Please provide your role">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 order-0 order-lg-1">
                        ...
                        <div style="width:100%;margin-bottom:50px;" class="text-center">
                         ...
                         <a href="<?php echo get_site_url()?>/users-profile-pic/?profiletab=main&um_action=edit" >
                            <div style="width:100%;margin-bottom: 45px;" class="text-center">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="facebook" name = "facebook" value="<?php echo $user_Info->facebook ;?>" placeholder="Please provide your facebook url">
                        </div>
                            
                         <div class="form-group">
                            <h6 class="dashboard-title3 small-text secondary-color1" style="text-transform:none;"> Twitter </h6>
                            <input type="text" class="form-control" id="twitter" name = "twitter" value="<?php echo $user_Info->twitter ;?>" placeholder="Please provide your Twitter url">
                        </div>
                         <div class="form-group">
                            <h6 class="dashboard-title3 small-text secondary-color1" style="text-transform:none;"> LinkedIn </h6>
                            <input type="text"  class="form-control" id="linkedIn" name = "linkedIn" value="<?php echo $user_Info->linkedin ;?>" placeholder="Please provide your LinkedIn url">
                        </div>
                        
                         <div class="form-group">
                            <h6 class="dashboard-title3 small-text secondary-color1" style="text-transform:none;"> Instagram </h6>
                            <input type="text" class="form-control" id="instagram" name = "instagram" value="<?php echo $user_Info->instagram ;?>" placeholder="Please provide your Instagram url">
                        </div>
                ...
                <div class="row no-margin">
                    <div class="col-xl-6 col-lg-8">                            
                        <div class="form-group">
                            <h6 class="dashboard-title3 small-text secondary-color1" style="text-transform:none;">Short Bio</h6>
...
<script>
    ...
    $(document).on('submit', "#UserInfoUpdate", function(e) {
      ...
      if(validate_url(fb,tw,lin,inst)){

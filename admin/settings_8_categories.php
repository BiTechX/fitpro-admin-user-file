    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="padding-15px" style="margin-bottom:20px;">
                ...
                <a href="settings_8_categories.php"><button class="btn theme-rounded-button secondary-color1-border secondary-color1-border-hover secondary-color1 transparent-background top-bar-button current-page-button" >Categories</button></a>
                                    ...
                                    <div class="row">
                                       <!-- <div class="col-1 backend-module-edit-iconsholder backend-module-edit-iconsholder-left">
                                        ...
                                        <div class="col-4 backend-module-edit-iconsholder "  >
                                            ...
                                            <i class="flt flaticon-rubbish-bin secondary-color1" style="padding-left:10px;" id="delete_categary" data-id="<?php echo $category->term_id ;?>"></i>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).on('submit', "#AddNewCategory", function(e) {
            ...
            var url = "<?php echo FITPRO_THEME_BTX_fun_add_new_category_api_url();?>";
      ...
      $(document).on('click', "#delete_categary", function(e) {
            ...
            if(isconf){
                ...
                //alert(value);
                var url = "<?php echo FITPRO_THEME_BTX_fun_delete_category_api_url();?>"+value;
